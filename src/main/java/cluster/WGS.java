...
//
//
//    public List<Map<String,Map<String, Map<String,String>>>> wgsQuery(String phone)throws IOException {
...
//
//
////        Scan scanPhone = new Scan();
////        scanPhone.setFilter(new SingleColumnValueFilter(Bytes.toBytes("Info"), Bytes.toBytes("phoneNum"),
////                CompareOperator.EQUAL, Bytes.toBytes(phone)));
////        ResultScanner resultScannerPhone = phoneEnrollInfo.getScanner(scanPhone);
//
//        Result result;
...
////        }
////        System.out.println("No more information about phone number " + phone);
////        resultScannerPhone.close();
//
//        return resultList;
//    }
//
